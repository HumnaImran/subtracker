...
<div class="main-wrapper">
    <div class="header">
      ...
      <div class="header-left"><h1>Subscription Plans</h1></div>
...
Poppins; color: rgba(164, 29, 48, 1);">Logout</a>
    ...
    <div class="page-wrapper" style="margin-bottom: 30rem;">
      <div class="content container-fluid mb-5" style="margin-left: 0rem;">
          <div class="page-header">
            <p class="plan-para" style="font-size: 16px;
            font-weight: 400;
            color:rgb(155, 154, 154);;
            font-family: Poppins ;">Choose the Plan That Fits Your Subscription Needs</p>
          </div>
          <div class="row d-flex  plan-cardmain bg-white" style="margin-right: 0rem;">
            <div class="col-sm-5  px-0 mx-0  ">
              <div class="plan-card  border-0 start-0 " style="padding-top: 2rem;">
                <p class="plan-card-text">Free For 1 Month</p>
                <div class="px-lg-5   px-md-4 px-3 py-5 ">
                  <h5>Monthly Plan</h5>
                  <h3 style="font-weight: 700;">29.95CHF <span class=" fs-6" style="font-size: 13px;
                      font-weight: 500;
                      color:rgb(155, 154, 154);;
                      font-family: Poppins ;">/MONTH</span></h3>
                  <div class="">
                    <div class="d-flex gap-2 pt-3">
                      <span class=""> <img src="./assets/img/subtrackr-images/checked.png" class="img-fluid me-2" width="24" alt=""></span>
                    ...
                    <div class="d-flex gap-2 mb-4">
                      <span> <img src="./assets/img/subtrackr-images/checked.png" class="img-fluid me-2" width="24" alt=""></span>
                      <p class="mt-1">Priority Support</p>
                    </div>
                    <a href="payment.html" class="text-secondary">Get Started <i class="fa-solid fa-arrow-right ms-1"></i></a>
                  </div>
                </div>
              </div>
            </div>
            <div class=" col-sm-7 px-0 mx-0 position-relative">
              <div class="yearly-plane border-0">
                <div class="px-lg-5 px-md-4 px-3 pt-5 pt-md-0 pb-5">
                  <h5 class=" text-light" style="padding-top: 5rem;">Yearly Plan <span class=" fs-6 fw-light ps-4" style="color:rgba(117, 138, 255, 1); " >Save 20%</span></h5>
                  <h3 class=" text-light">29.95CHF <span class=" fw-light fs-6" style="color:rgb(155, 154, 154);">/YEAR</span> </h3>
                  <div class="">
                    ...
                    <div class="d-flex gap-2">
                      <span> <img src="./assets/img/subtrackr-images/checked.png" class="img-fluid me-2" width="24" alt=""></span>
                      <p class="">Priority Support</p>
                    </div>
                    <a href="payment.html">
                      <button class="btn btn-outline-light bg-transparent text-white px-4 mt-4 py-2" type="button">Get Started <span><i class="fa-solid fa-arrow-right ms-1"></i></span>
                      </button>
                    </a>
