...
<div class="main-wrapper" style="font-family: poppins;">
    <div class="header">
      ...
      <div class="header-left" ><h1 style="font-family: poppins;">Contact & Support</h1></div>
      ...
      <div class="content container-fluid" style="margin-left: 1rem;">
        <div class="row">
          <div class="col-lg-8">
            <div>
              <div class="my-3">
                <h6 class=" fs-6 m-0 p-0" style="font-size: 19px;
                font-weight: 400;
                color:rgba(145, 145, 145, 1);;
                font-family: Poppins ;">
                  Need help? Contact our friendly support team for assistance <br> with
                  any inquiries or issues.
                </h6>
              </div>
              <div class="mb-3 generalticketmain">
                <h3 style="font-family: poppins;">Generate Ticket</h3>
              </div>
            </div>

            <div class="mb-3">
              <h5 class="ticket-id">Ticket ID : FAWER123456</h5>
            </div>

            <div>
              <form>
                <div class="mb-3">
                  <label for="issues" class="form-label font-weightss">Issues</label>
                  <select class="form-select" aria-label="issues" style="color: grey;border-radius: 9px">
            ...
            <form>
              <div class="mb-3">
                <label for="subject" class="form-label font-weightss">Subject</label>
                <input type="password" class="form-control" id="subject" placeholder="Enter Subject" style="border-radius: 9px;" />
              </div>
              <div class="mb-3">
                <label for="description" class="form-label font-weightss">Description</label>
                <textarea
                  class="form-control"
                  id="description"
                  placeholder="Enter Description"
                  rows="5" style="border-radius: 9px"
                ></textarea>
              </div>
              <div class="d-flex align-items-lg-end mb-4 offset-0 offset-md-10">
                <button
                  type="submit"
                  class="btn px-4 btn-width text-light"
