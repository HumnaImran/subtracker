...
<div class="main-wrapper">
    <div class="header">
      ...
      <div class="header-left"><h1>Terms of Service</h1></div>
...
Poppins; color: rgba(164, 29, 48, 1);">Logout</a>
    ...
    <div class="page-wrapper">
      <div class="content container-fluid">
        <div class="page-header">
          <p class="subtrack1-para">
            Join our premium plan and safe money by tracking your
            subscriptions!
          </p>
        </div>
        <div class="row">
          <div class="col-lg-12 mt-5">
            <div
              class="d-flex flex-column justify-content-center align-items-center pt-lg-5"
            >
              <a href="" class="pt-4"
                ><svg
                  width="40"
                ...
                >
                  <path
                    d="M15.5906 14.5312L19.8969 6H20.3844L24.6906 14.5312H15.5906ZM18.9219 33.7875L4.90625 16.9688H18.9219V33.7875ZM21.3594 33.7875V16.9688H35.375L21.3594 33.7875ZM27.3719 14.5312L23.1469 6H31.5156L35.7812 14.5312H27.3719ZM4.5 14.5312L8.76562 6H17.1344L12.9094 14.5312H4.5Z"
                    fill="#757784"
                  />
                </svg>
              </a>
              <p class="subtrack1-para pt-4 text-center">
                Your Free Trial is Over. Subscribe to Upgrade to get<br />
                Premium Features
              </p>
            </div>
          </div>
    ...
    <div class="modal-dialog modalcust">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5 mx-3 id="settingModalLabel">Account Settings</h1>
        ...
        <div class="modal-body p-4">
           ...
           <div class="mx-2 modal-box mb-2 rounded">
            <div class="d-flex justify-content-between align-items-center gap-3 px-2">
             <p class="pt-3">
               <span><img src= "assets/img/mdi_language.png" class=" me-2" ></i></span>
               Language
             </p>
            ...
            <div class="mx-2 modal-box mb-2 rounded">
              <div class="d-flex justify-content-between align-items-center gap-3 px-2">
               <p class="pt-3">
                 <span><img src= "assets/img/ic_round-currency-yen.png" class=" me-2"></i></span>
                 Currency
            ...
            <div class="mx-2 modal-box mb-2 rounded">
              <div class="d-flex justify-content-between align-items-center gap-3 px-2">
               <p class="pt-3">
                 <span><img src= "assets/img/carbon_password.png" class=" me-2"></span>
                 Change Password
               </p>
                ...
                <div class="mx-2 modal-box rounded">
                  <div class="pt-3 form-check form-switch form-check-reverse d-flex justify-content-between mx-2 py-2 mb-2 ps-0">
                    <label class="form-check-label" for="flexSwitchCheckReverse2">
                      <span><img src="assets/img/images/images/Vector-removebg-preview.png" class="img-fluid me-2" width="22" alt=""></span>
  ...
  <div class="modal-content ">
  <div class="modal-header">
    <h1 class="modal-title fs-5 mx-3 p-0 id="infoModalLabel">Personal Data</h1>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
  </div>
  <div class="modal-body">
     ...
     <form action="" class="mx-4  ">
      <div class="mb-3 personal-data position-relative">
      ...
      <div class="mb-3 personal-data position-relative mb-5">
        <label for="emailInput" class="form-label">Phone No.</label>
        <input type="tel" class="form-control" id="emailInput" placeholder="Phone No">
        <span class="position-absolute"><i class="fa-solid fa-phone text-secondary"></i></span>
      </div>
      <div style="width:100%; display: flex;justify-content: center; align-items: center;">
          <button class="btn btn-save  mt-5 mb-5" style="width:80%; border-radius: 20px;">Save</button>
      </div>
  ...
  <div style="width:100%; display: flex;justify-content: center; align-items: center;">
    <button class="btn btn-save mt-4 mb-5" style="width:80%; border-radius: 20px;">Save</button>
  </div>
    </div>
  ...
  <div class="modal-body mx-4 d-flex flex-column justify-content-between">
     <form action="" class="mx-2">
      <div class="mb-2 mt-4 personal-data position-relative">
      ...
      <div class="mb-5 mt-4 personal-data position-relative">
